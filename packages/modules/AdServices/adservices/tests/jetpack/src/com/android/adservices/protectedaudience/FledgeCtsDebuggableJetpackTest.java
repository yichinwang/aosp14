...
package com.android.adservices.protectedaudience;
...
public class FledgeCtsDebuggableJetpackTest {
    protected static final Context sContext = ApplicationProvider.getApplicationContext();
    private static final String TAG = "FledgeCtsDebuggableJetpackTest";
    ...
    public void testAdSelectionFlow_skipExpiredCA_Success() throws Exception {
        ...
        doSleep(caTimeToExpireSeconds * 2L * 1000L);
    ...
    private static void doSleep(long timeout) {
        Log.d(TAG, String.format("Starting to sleep for %d ms", timeout));
        long currentTime = System.currentTimeMillis();
        long wakeupTime = currentTime + timeout;
        while (wakeupTime - currentTime > 0) {
            Log.d(TAG, String.format("Time left to sleep: %d ms", wakeupTime - currentTime));
            try {
    ...
    private static class CustomAudienceClient {
        ...
        public ListenableFuture<Unit> leaveCustomAudience(AdTechIdentifier buyer, String name) {
