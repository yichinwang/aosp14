...
function generateBid(custom_audience, auction_signals, per_buyer_signals, trusted_bidding_signals, contextual_signals) {
    forDebuggingOnly.reportAdAuctionWin('<buyer-win-debug-reporting-uri>' + "?wb=${winningBid}&madeWb=${madeWinningBid}");
    forDebuggingOnly.reportAdAuctionLoss('<buyer-loss-debug-reporting-uri>' + "?wb=${winningBid}&madeWb=${madeWinningBid}");
    var bid = 5;
