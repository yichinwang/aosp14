...
/** Dao to register, access and update encoder endpoints for buyers */
@Dao
public interface EncoderEndpointsDao {
    ...
    /**
     * @param buyer Ad-tech whose encoder we will fetch from the endpoint
     * @return an instance of {@link DBEncoderEndpoint} if present
     */
