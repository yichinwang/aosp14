...
public class GenericDocumentParcelTest {
    ...
    public void testPropertyParcel_onePropertySet_success() {
        ...
        assertThat(
                        new PropertyParcel.Builder("name")
                                ...
                                .build()
                                .getStringValues())
                .isEqualTo(Arrays.copyOf(stringValues, stringValues.length));
        assertThat(
                        new PropertyParcel.Builder("name")
        ...
        assertThat(
                        new PropertyParcel.Builder("name")
                                ...
                                .build()
                                .getDoubleValues())
                .isEqualTo(Arrays.copyOf(doubleValues, doubleValues.length));
        assertThat(
                        new PropertyParcel.Builder("name")
                                .setBooleanValues(booleanValues)
                                .build()
                                .getBooleanValues())
                .isEqualTo(Arrays.copyOf(booleanValues, booleanValues.length));
        assertThat(
                        new PropertyParcel.Builder("name")
                                .setBytesValues(bytesValues)
                                .build()
                                .getBytesValues())
    ...
    public void testPropertyParcel_moreThanOnePropertySet_exceptionThrown() {
        ...
        IllegalArgumentException exception =
                assertThrows(IllegalArgumentException.class, () -> propertyParcelBuilder.build());
    ...
    public void testGenericDocumentParcel_propertiesGeneratedCorrectly() {
        ...
        assertThat(propertyMap)
                .containsExactly(
                        "longArray", longArrayProperty, "stringArray", stringArrayProperty);
    }
    ...
    public void testGenericDocumentParcel_buildFromAnotherDocumentParcelCorrectly() {
        ...
        assertThat(genericDocumentParcelCopy.getNamespace())
                .isEqualTo(genericDocumentParcel.getNamespace());
        assertThat(genericDocumentParcelCopy.getId()).isEqualTo(genericDocumentParcel.getId());
        assertThat(genericDocumentParcelCopy.getSchemaType())
                .isEqualTo(genericDocumentParcel.getSchemaType());
        assertThat(genericDocumentParcelCopy.getCreationTimestampMillis())
                .isEqualTo(genericDocumentParcel.getCreationTimestampMillis());
        assertThat(genericDocumentParcelCopy.getTtlMillis())
                .isEqualTo(genericDocumentParcel.getTtlMillis());
        assertThat(genericDocumentParcelCopy.getScore())
                .isEqualTo(genericDocumentParcel.getScore());
        // Check it is a copy.
        assertThat(genericDocumentParcelCopy).isNotSameInstanceAs(genericDocumentParcel);
        assertThat(genericDocumentParcelCopy.getProperties())
                .isEqualTo(genericDocumentParcel.getProperties());
    }
}
