...
public class PrefixUtilTest {
    ...
    public void testRemovePrefix_missingDelimiter() {
        AppSearchException e =
                assertThrows(AppSearchException.class, () -> PrefixUtil.removePrefix("foo$bar"));
        assertThat(e)
                .hasMessageThat()
                .isEqualTo("The prefixed value \"foo$bar\" doesn't contain a valid database name");

        e = assertThrows(AppSearchException.class, () -> PrefixUtil.removePrefix("foo"));
        assertThat(e)
                .hasMessageThat()
                .isEqualTo("The prefixed value \"foo\" doesn't contain a valid database name");
    }
    ...
    public void testGetPrefix_missingDelimiter() {
        AppSearchException e =
                assertThrows(AppSearchException.class, () -> PrefixUtil.getPrefix("foo$bar"));
        assertThat(e)
                .hasMessageThat()
                .isEqualTo("The prefixed value \"foo$bar\" doesn't contain a valid database name");
    ...
    public void testRemovePrefixesFromDocument_multiplePrefixNames() {
        ...
        assertThat(e)
                .hasMessageThat()
                .isEqualTo(
                        "Found unexpected multiple prefix names in "
