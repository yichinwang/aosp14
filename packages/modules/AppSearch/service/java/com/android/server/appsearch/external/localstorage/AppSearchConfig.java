...
public interface AppSearchConfig extends IcingOptionsConfig, LimitConfig {
    ...
    /**
     * Whether to store {@link GenericDocument}'s parent types as a synthetic property. If not, the
     * list of parent types will be wrapped as a meta field in {@link GenericDocument}, in a similar
     * way as namespace, id, creationTimestamp, etc.
     */
