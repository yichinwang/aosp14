...
public class UxrestrictionSnippet implements Snippet {
    ...
    public UxrestrictionSnippet() {
        mHardKeysHelper = new HelperAccessor<>(IAutoVehicleHardKeysHelper.class);
    }

    /** Enable Driving mode using shell command */
    @Rpc(description = "Enable Driving Mode")
    ...
    /** Enable Parking mode using shell command */
    @Rpc(description = "Disable Driving Mode")
