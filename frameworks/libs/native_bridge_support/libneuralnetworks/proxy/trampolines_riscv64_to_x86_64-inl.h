...
{"ANeuralNetworksCompilation_addExtensionAttribute", GetTrampolineFunc<auto(void*, void*, uint16_t, void*, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"ANeuralNetworksExecution_addExtensionAttribute", GetTrampolineFunc<auto(void*, void*, uint16_t, void*, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"ANeuralNetworksExecution_setInput", GetTrampolineFunc<auto(void*, int32_t, void*, void*, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"ANeuralNetworksExecution_setInputFromMemory", GetTrampolineFunc<auto(void*, int32_t, void*, void*, uint64_t, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"ANeuralNetworksExecution_setOutput", GetTrampolineFunc<auto(void*, int32_t, void*, void*, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"ANeuralNetworksExecution_setOutputFromMemory", GetTrampolineFunc<auto(void*, int32_t, void*, void*, uint64_t, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"ANeuralNetworksMemory_createFromFd", GetTrampolineFunc<auto(uint64_t, int32_t, int32_t, uint64_t, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"ANeuralNetworksModel_setOperandExtensionData", GetTrampolineFunc<auto(void*, int32_t, void*, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"ANeuralNetworksModel_setOperandValue", GetTrampolineFunc<auto(void*, int32_t, void*, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"ANeuralNetworksModel_setOperandValueFromMemory", GetTrampolineFunc<auto(void*, int32_t, void*, uint64_t, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
